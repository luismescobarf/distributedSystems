...
func main() {
	...
	// var canalMapas chan map[string]int
	// var arregloCanales []chan map[string]int
	// arregloCanales := make(chan map[string]int,4)
